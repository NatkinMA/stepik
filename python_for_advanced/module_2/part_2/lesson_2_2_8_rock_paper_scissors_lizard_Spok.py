...
def first_is_winner(first, second):
    return first == "камень" and (second == "ножницы" or second == "ящерица") \
        or first == "ножницы" and (second == "бумага" or second == "ящерица") \
        or first == "бумага" and (second == "камень" or second == "Спок") \
        or first == "ящерица" and (second == "Спок" or second == "бумага") \
        or first == "Спок" and (second == "ножницы" or second == "камень")

if timur == ruslan:
    print("ничья")
elif first_is_winner(timur, ruslan):
    print("Тимур")
elif first_is_winner(ruslan, timur):
    print("Руслан")